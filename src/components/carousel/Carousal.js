...
const Carousal = ({ data, loading, endpoint, title }) => {
    const carouselContainer = useRef(); // jis ke andar bhi ye variable pass kareng uska reference miljayega by ref tag
    //kisiko div ko select kare ka tarika just like getelementbyid 
